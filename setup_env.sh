...
# 0. Set System PATH (Fixes 'dpkg: error: PATH is not set')
...
echo "=================================================="
# Stop background services and kill existing locks
...
# Initialize Wine and suppress popups
wineboot -u
sleep 5

# Start Emulator + Wine + App
